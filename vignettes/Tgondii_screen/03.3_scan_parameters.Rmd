...
scan_params <- spaCRPower::scan_parameters(
  ...
  imaging_n_cells_per_well_lambda = 25,       # n cells per well/number genes per well
  ...
  progress_file = "intermediate_data/parameter_scan_20250619.tsv",
  verbose = TRUE)         
```
...
scan_param_jobs <- spaCRPower::scan_parameters_future(
  ...
  n_wells_per_screen = seq(from=3000, 5000, by = 20),
  well_abundance_factor_mu = 4.6,               # fitting parameters
  well_abundance_factor_var = 1,              # fitting parameters
  imaging_n_cells_per_well_lambda = 25,       # n cells per well/number genes per well
  imaging_n_cells_per_well_nu = 1,            # poisson sampling
  ...
  pcr_factor_var = 1,
  n_reads_total = 128318,                     # geometric mean of well reads
  progress_file = "intermediate_data/scan_params_w4.6/parameter_scan_20250620.tsv",
  verbose = TRUE)
